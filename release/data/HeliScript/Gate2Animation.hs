component Gate2LeftAnimation
{
    ...
    public Gate2LeftAnimation()
    {
        hsSystemOutput("Script:Gate2LeftAnimation\n");
...
component Gate2RightAnimation
{
    ...
    public Gate2RightAnimation()
    {
        hsSystemOutput("Script:Gate2RightAnimation\n");
