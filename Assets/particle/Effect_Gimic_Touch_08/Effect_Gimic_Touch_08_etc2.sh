...
PVRTexToolCLI -i "tex_sample/Texture006.png" -o tex_etc/Texture006.pvr -m 16 -f ETC2_RGBA,UBN,sRGB
PVRTexToolCLI -i "tex_sample/Texture007.png" -o tex_etc/Texture007.pvr -m 16 -f ETC2_RGBA,UBN,sRGB
